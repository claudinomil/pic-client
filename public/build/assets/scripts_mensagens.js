...
//
//     filtrar_novas_conversas();
// }

function filtrar_novas_conversas() {
    $(".filtrar_novas_conversas").each(function(index) {
    ...
    return new Promise((resolve, reject) => {
        ...
        $.get("mensagens/conversas/"+remetente_user_id+"/"+destinatario_user_id, function (data) {
            if (data.success) {
                ...
                reject('Não encontrou Conversas');
            }
        });
    });
}
