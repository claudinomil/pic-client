...
@section('title') Tipos Escolas @endsection
...
<!-- Modal -->
@include('tipos_escolas.form')
@endsection

@section('script')
    <!-- scripts_tipos_escolas.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_tipos_escolas.js')}}"></script>
@endsection
