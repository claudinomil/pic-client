...
@section('title') Necessidades Educacionais Específicas @endsection
                                    ...
                                    <div class="row">
                                        <div class="col-5 float-end px-1">
                                            <select class="form-control" id="pesquisar_field" name="pesquisar_field" placeholder="Campo Pesquisar">
                                                <option value="nees.name">Nome</option>
                                                <option value="nees.descricao">Descrição</option>
                                            </select>
                                        </div>
                                        <div class="col-5 float-end px-1">
...
@section('script')
    <!-- scripts_nees.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_nees.js')}}"></script>
@endsection
