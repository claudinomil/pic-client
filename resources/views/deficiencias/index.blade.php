...
@section('title') Deficiências @endsection
                                    ...
                                    <div class="row">
                                        <div class="col-5 float-end px-1">
                                            <select class="form-control" id="pesquisar_field" name="pesquisar_field" placeholder="Campo Pesquisar">
                                                <option value="deficiencias.name">Nome</option>
                                                <option value="deficiencias.descricao">Descrição</option>
                                            </select>
                                        </div>
                                        <div class="col-5 float-end px-1">
...
<!-- Modal -->
@include('deficiencias.form')
@endsection

@section('script')
    <!-- scripts_deficiencias.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_deficiencias.js')}}"></script>
@endsection
