        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-5 float-end px-1">
                                            <select class="form-control" id="pesquisar_field" name="pesquisar_field" placeholder="Campo Pesquisar">
                                                <option value="calendarios_inclusivos.evento">Evento</option>
                                            </select>
                                        </div>
                                        <div class="col-5 float-end px-1">
                    ...
                    @php
                        $colsNames = ['Data', 'Evento', 'Sugestão de Atividade'];
                        $colsFields = ['data_evento', 'evento', 'sugestao_atividade'];
                        $colActions = 'yes';
                    @endphp
...
<!-- Modal -->
@include('calendarios_inclusivos.form')
@endsection

@section('script')
    <!-- scripts_calendarios_inclusivos.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_calendarios_inclusivos.js')}}"></script>
@endsection
