...
@section('title') Níveis Ensinos @endsection
...
<!-- Modal -->
@include('niveis_ensinos.form')
@endsection

@section('script')
    <!-- scripts_niveis_ensinos.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_niveis_ensinos.js')}}"></script>
@endsection
