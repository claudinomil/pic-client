        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-5 float-end px-1">
                                            <select class="form-control" id="pesquisar_field" name="pesquisar_field" placeholder="Campo Pesquisar">
                                                <option value="turmas.name">Nome</option>
                                                <option value="escolas.name">Escola</option>
                                            </select>
                                        </div>
                                        <div class="col-5 float-end px-1">
                    ...
                    @php
                        $colsNames = ['Nome', 'Escola', 'Nível Ensino'];
                        $colsFields = ['name', 'escolaName', 'nivelEnsinoName'];
                        $colActions = 'yes';
                    @endphp
...
@section('script')
    <!-- scripts_turmas.js -->
    <script src="{{ Vite::asset('resources/assets_template/js/scripts_turmas.js')}}"></script>
@endsection
