                ...
                <div class="card-body">
                    ...
                    <form id="{{$ajaxNameFormSubmodulo}}" name="{{$ajaxNameFormSubmodulo}}">
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="row pt-4">
                                ...
                                <div class="row col-12">
                                    ...
                                    <div class="form-group col-12 col-md-4 pb-3">
                                        ...
                                        <input type="text" class="form-control mask_date" id="data_matricula" name="data_matricula" required="required">
                                    </div>
                                </div>
                            </div>

                            <div class="row pt-4">
                                <h5 class="pb-4 text-primary"><i class="fas fa-book-medical"></i> Necessidades Educacionais Especiais</h5>
                                <div class="form-group col-12 col-md-12 pb-3">
                                    <div class="row ms-1 pb-2">
                                        @foreach ($nees as $key => $nee)
                                            <div class="col-6 col-md-3 px-2 py-2">
                                                <div class="form-check form-checkbox-outline form-check-danger">
                                                    <input class="form-check-input cbNeeId" type="checkbox" id="nee_id_{{ $nee['id'] }}" name="nee_id_{{ $nee['id'] }}">
                                                    <label class="form-check-label" for="nee_id_{{ $nee['id'] }}">{{ $nee['name'] }}</label>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                            ...
                            <div class="row pt-4" id="divInformacoesEducacionais" style="display: none;">
                                <h5 class="pb-4 text-primary"><i class="fas fa-clinic-medical"></i> Informações Educacionais</h5>
                                <div class="form-group col-12 col-md-12 pb-3" id="divInformacoesEducacionaisUpload">
...
{{--                                        </div>--}}
                                ...
                                <div class="row col-12">
                                    ...
                                    <div class="form-group col-12 col-md-8 pb-3" style="display: none;">
                                ...
                                <div class="row col-12">
                                    <div class="form-group col-12 col-md-4 pb-3" style="display: none;">
                                        <label class="form-label">Laudo NEE ou Transtorno</label>
                                        <select class="form-control select2" name="laudo_nee_ou_transtorno" id="laudo_nee_ou_transtorno">
                                            <option value="">Selecione...</option>
                                            <option value="1">Sim</option>
                                            <option value="0">Não</option>
                                        </select>
                                    ...
                                    <div class="form-group col-12 col-md-8 pb-3" style="display: none;">
                                        <label class="form-label">Laudo NEE ou Transtorno - Descrição</label>
                                        <textarea class="form-control" id="laudo_nee_ou_transtorno_descricao" name="laudo_nee_ou_transtorno_descricao"></textarea>
                                    </div>
                                </div>
                            </div>
